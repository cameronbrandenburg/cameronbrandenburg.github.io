...
app.put('/api/restaurants/:id',(req,res)=>{
    ...
    updateRestaurant(res, req.params.id, req.body.name, req.body.website, req.body.address, req.body.priceRange, req.body.specialties, req.body.rating, req.body.hours);
});

async function updateRestaurant(res, id, name, website, address, priceRange, specialties, rating, hours){
