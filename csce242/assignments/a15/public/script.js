...
async function showRestaurantDetails(){
    ...
    document.getElementById("txt-website").value = restaurant.website;
    ...
    document.getElementById("a-website").textContent = `Visit Website`;
    document.getElementById("a-website").href = `#`;
...
async function addRestaurant(){
    ...
    let restaurantWebsite = document.getElementById("txt-add-website").value;
    ...
    document.getElementById("txt-add-website").value = "";
...
async function editRestaurant(){
    ...
    let restaurantWebsite = document.getElementById("txt-website").value;
